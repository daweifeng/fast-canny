...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "4.10.0"
  WORKING_DIRECTORY "/afs/andrew.cmu.edu/usr14/hahmadi/public/fast-canny/external/opencv"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("4.10.0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/4.10.0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/afs/andrew.cmu.edu/usr14/hahmadi/public/fast-canny/external/opencv'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/afs/andrew.cmu.edu/usr14/hahmadi/public/fast-canny/external/opencv'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
